...
public class TesteClasseAnonima {
	...
	public static void main(String[] args) {
		...
		// Function Objects
		// NumeroDaContaComparator2 comparator = ;
...
//		Comparator<Conta> testee = new Comparator<Conta>() { // classe anonima
//			public int compare(Conta c1, Conta c2) {
//				return Integer.compare(c1.getNumero(), c2.getNumero());
//			}
//		};
		...
		for (Conta conta : lista) {
			System.out.println(conta.toString() + ", Nome do Titular: " + conta.getTitular().getNome() + ", Saldo: "
					+ conta.getSaldo());
		}
